...
impl<'a> AccountInfo<'a> {
  ...
  #[inline]
  pub fn pubkey(&self) -> Option<super::common::Pubkey<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<super::common::Pubkey>>(AccountInfo::VT_PUBKEY, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn owner(&self) -> Option<super::common::Pubkey<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<super::common::Pubkey>>(AccountInfo::VT_OWNER, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for AccountInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<super::common::Pubkey>>("pubkey", Self::VT_PUBKEY, false)?
     .visit_field::<u64>("lamports", Self::VT_LAMPORTS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<super::common::Pubkey>>("owner", Self::VT_OWNER, false)?
...
pub struct AccountInfoArgs<'a> {
    pub pubkey: Option<flatbuffers::WIPOffset<super::common::Pubkey<'a>>>,
    pub lamports: u64,
    pub owner: Option<flatbuffers::WIPOffset<super::common::Pubkey<'a>>>,
    pub executable: bool,
    pub rent_epoch: u64,
...
impl<'a: 'b, 'b> AccountInfoBuilder<'a, 'b> {
  #[inline]
  pub fn add_pubkey(&mut self, pubkey: flatbuffers::WIPOffset<super::common::Pubkey<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<super::common::Pubkey>>(AccountInfo::VT_PUBKEY, pubkey);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_owner(&mut self, owner: flatbuffers::WIPOffset<super::common::Pubkey<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<super::common::Pubkey>>(AccountInfo::VT_OWNER, owner);
  }
  #[inline]
