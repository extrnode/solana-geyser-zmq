...
impl<'a> Pubkey<'a> {
  ...
  pub fn key(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Pubkey::VT_KEY, None)}
  }
}
...
impl<'a> Signature<'a> {
  ...
  pub fn key(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Signature::VT_KEY, None)}
  }
}
...
impl<'a: 'b, 'b> SignatureBuilder<'a, 'b> {
  #[inline]
  pub fn add_key(&mut self, key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Signature::VT_KEY, key);
  }
  #[inline]
