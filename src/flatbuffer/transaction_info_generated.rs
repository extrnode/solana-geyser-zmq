...
impl<'a> TransactionInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.transaction_meta { builder.add_transaction_meta(x); }
  ...
  pub fn transaction(&self) -> Option<SanitizedTransaction<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<SanitizedTransaction>>(TransactionInfo::VT_TRANSACTION, None)}
  }
  #[inline]
  pub fn transaction_meta(&self) -> Option<TransactionStatusMeta<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<TransactionStatusMeta>>(TransactionInfo::VT_TRANSACTION_META, None)}
  }
}
...
impl<'a: 'b, 'b> TransactionInfoBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_transaction(&mut self, transaction: flatbuffers::WIPOffset<SanitizedTransaction<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<SanitizedTransaction>>(TransactionInfo::VT_TRANSACTION, transaction);
  }
  #[inline]
  pub fn add_transaction_meta(&mut self, transaction_meta: flatbuffers::WIPOffset<TransactionStatusMeta<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<TransactionStatusMeta>>(TransactionInfo::VT_TRANSACTION_META, transaction_meta);
  }
  #[inline]
...
impl<'a> SanitizedTransaction<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.message_hash { builder.add_message_hash(x); }
  ...
  pub fn message_type(&self) -> SanitizedMessage {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<SanitizedMessage>(SanitizedTransaction::VT_MESSAGE_TYPE, Some(SanitizedMessage::NONE)).unwrap()}
  }
  #[inline]
  pub fn message(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(SanitizedTransaction::VT_MESSAGE, None)}
  }
  #[inline]
  pub fn message_hash(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SanitizedTransaction::VT_MESSAGE_HASH, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for SanitizedTransaction<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<SanitizedMessage, _>("message_type", Self::VT_MESSAGE_TYPE, "message", Self::VT_MESSAGE, false, |key, v, pos| {
        match key {
          SanitizedMessage::Legacy => v.verify_union_variant::<flatbuffers::ForwardsUOffset<LegacyMessage>>("SanitizedMessage::Legacy", pos),
          SanitizedMessage::V0 => v.verify_union_variant::<flatbuffers::ForwardsUOffset<LoadedMessageV0>>("SanitizedMessage::V0", pos),
          _ => Ok(()),
        }
     })?
...
impl<'a: 'b, 'b> SanitizedTransactionBuilder<'a, 'b> {
  ...
  pub fn add_message_type(&mut self, message_type: SanitizedMessage) {
    self.fbb_.push_slot::<SanitizedMessage>(SanitizedTransaction::VT_MESSAGE_TYPE, message_type, SanitizedMessage::NONE);
  }
  #[inline]
  pub fn add_message(&mut self, message: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SanitizedTransaction::VT_MESSAGE, message);
  }
  #[inline]
  pub fn add_message_hash(&mut self, message_hash: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SanitizedTransaction::VT_MESSAGE_HASH, message_hash);
  }
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SanitizedTransactionBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> LegacyMessage<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.recent_blockhash { builder.add_recent_blockhash(x); }
  ...
  pub fn recent_blockhash(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(LegacyMessage::VT_RECENT_BLOCKHASH, None)}
  }
  #[inline]
  pub fn instructions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CompiledInstruction<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CompiledInstruction>>>>(LegacyMessage::VT_INSTRUCTIONS, None)}
  }
}
...
impl<'a: 'b, 'b> LegacyMessageBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_recent_blockhash(&mut self, recent_blockhash: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LegacyMessage::VT_RECENT_BLOCKHASH, recent_blockhash);
  }
  #[inline]
  pub fn add_instructions(&mut self, instructions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<CompiledInstruction<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LegacyMessage::VT_INSTRUCTIONS, instructions);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> LegacyMessageBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> MessageHeader<'a> {
  ...
  pub fn num_required_signatures(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(MessageHeader::VT_NUM_REQUIRED_SIGNATURES, Some(0)).unwrap()}
  }
  #[inline]
  pub fn num_readonly_signed_accounts(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(MessageHeader::VT_NUM_READONLY_SIGNED_ACCOUNTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn num_readonly_unsigned_accounts(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(MessageHeader::VT_NUM_READONLY_UNSIGNED_ACCOUNTS, Some(0)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for MessageHeader<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<u8>("num_required_signatures", Self::VT_NUM_REQUIRED_SIGNATURES, false)?
     .visit_field::<u8>("num_readonly_signed_accounts", Self::VT_NUM_READONLY_SIGNED_ACCOUNTS, false)?
     .visit_field::<u8>("num_readonly_unsigned_accounts", Self::VT_NUM_READONLY_UNSIGNED_ACCOUNTS, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> MessageHeaderBuilder<'a, 'b> {
  ...
  pub fn add_num_required_signatures(&mut self, num_required_signatures: u8) {
    self.fbb_.push_slot::<u8>(MessageHeader::VT_NUM_REQUIRED_SIGNATURES, num_required_signatures, 0);
  }
  #[inline]
  pub fn add_num_readonly_signed_accounts(&mut self, num_readonly_signed_accounts: u8) {
    self.fbb_.push_slot::<u8>(MessageHeader::VT_NUM_READONLY_SIGNED_ACCOUNTS, num_readonly_signed_accounts, 0);
  }
  #[inline]
  pub fn add_num_readonly_unsigned_accounts(&mut self, num_readonly_unsigned_accounts: u8) {
    self.fbb_.push_slot::<u8>(MessageHeader::VT_NUM_READONLY_UNSIGNED_ACCOUNTS, num_readonly_unsigned_accounts, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> MessageHeaderBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl core::fmt::Debug for MessageHeader<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("MessageHeader");
      ...
      ds.field("num_readonly_signed_accounts", &self.num_readonly_signed_accounts());
      ds.field("num_readonly_unsigned_accounts", &self.num_readonly_unsigned_accounts());
      ds.finish()
  }
}
...
impl<'a> LoadedMessageV0<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.loaded_addresses { builder.add_loaded_addresses(x); }
    if let Some(x) = args.message { builder.add_message(x); }
    builder.finish()
  }
  ...
  pub fn message(&self) -> Option<MessageV0<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<MessageV0>>(LoadedMessageV0::VT_MESSAGE, None)}
  }
  #[inline]
  pub fn loaded_addresses(&self) -> Option<LoadedAddresses<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<LoadedAddresses>>(LoadedMessageV0::VT_LOADED_ADDRESSES, None)}
  }
}
...
impl flatbuffers::Verifiable for LoadedMessageV0<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<MessageV0>>("message", Self::VT_MESSAGE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<LoadedAddresses>>("loaded_addresses", Self::VT_LOADED_ADDRESSES, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> LoadedMessageV0Builder<'a, 'b> {
  ...
  pub fn add_message(&mut self, message: flatbuffers::WIPOffset<MessageV0<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<MessageV0>>(LoadedMessageV0::VT_MESSAGE, message);
  }
  #[inline]
  pub fn add_loaded_addresses(&mut self, loaded_addresses: flatbuffers::WIPOffset<LoadedAddresses<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<LoadedAddresses>>(LoadedMessageV0::VT_LOADED_ADDRESSES, loaded_addresses);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> LoadedMessageV0Builder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> MessageV0<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.address_table_lookups { builder.add_address_table_lookups(x); }
    if let Some(x) = args.instructions { builder.add_instructions(x); }
    if let Some(x) = args.recent_blockhash { builder.add_recent_blockhash(x); }
    if let Some(x) = args.account_keys { builder.add_account_keys(x); }
    if let Some(x) = args.header { builder.add_header(x); }
  ...
  pub fn recent_blockhash(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MessageV0::VT_RECENT_BLOCKHASH, None)}
  }
  #[inline]
  pub fn instructions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CompiledInstruction<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CompiledInstruction>>>>(MessageV0::VT_INSTRUCTIONS, None)}
  }
  #[inline]
  pub fn address_table_lookups(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MessageAddressTableLookup<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MessageAddressTableLookup>>>>(MessageV0::VT_ADDRESS_TABLE_LOOKUPS, None)}
  }
}
...
impl<'a: 'b, 'b> MessageV0Builder<'a, 'b> {
  ...
  #[inline]
  pub fn add_recent_blockhash(&mut self, recent_blockhash: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MessageV0::VT_RECENT_BLOCKHASH, recent_blockhash);
  }
  #[inline]
  pub fn add_instructions(&mut self, instructions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<CompiledInstruction<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MessageV0::VT_INSTRUCTIONS, instructions);
  }
  #[inline]
  pub fn add_address_table_lookups(&mut self, address_table_lookups: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MessageAddressTableLookup<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MessageV0::VT_ADDRESS_TABLE_LOOKUPS, address_table_lookups);
  }
  #[inline]
...
impl<'a> MessageAddressTableLookup<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.readonly_indexes { builder.add_readonly_indexes(x); }
    if let Some(x) = args.writable_indexes { builder.add_writable_indexes(x); }
    if let Some(x) = args.account_key { builder.add_account_key(x); }
    builder.finish()
  }
  ...
  pub fn writable_indexes(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MessageAddressTableLookup::VT_WRITABLE_INDEXES, None)}
  }
  #[inline]
  pub fn readonly_indexes(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MessageAddressTableLookup::VT_READONLY_INDEXES, None)}
  }
}
...
impl<'a: 'b, 'b> MessageAddressTableLookupBuilder<'a, 'b> {
  ...
  pub fn add_writable_indexes(&mut self, writable_indexes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MessageAddressTableLookup::VT_WRITABLE_INDEXES, writable_indexes);
  }
  #[inline]
  pub fn add_readonly_indexes(&mut self, readonly_indexes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MessageAddressTableLookup::VT_READONLY_INDEXES, readonly_indexes);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> MessageAddressTableLookupBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> LoadedAddresses<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.readonly { builder.add_readonly(x); }
    if let Some(x) = args.writable { builder.add_writable(x); }
    builder.finish()
  }
...
impl<'a: 'b, 'b> LoadedAddressesBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> LoadedAddressesBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> InstructionErrorData<'a> {
  ...
  pub fn instruction_number(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(InstructionErrorData::VT_INSTRUCTION_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn err(&self) -> Option<InstructionError<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<InstructionError>>(InstructionErrorData::VT_ERR, None)}
  }
}
...
impl flatbuffers::Verifiable for InstructionErrorData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<InstructionError>>("err", Self::VT_ERR, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> InstructionErrorDataBuilder<'a, 'b> {
  ...
  pub fn add_instruction_number(&mut self, instruction_number: u8) {
    self.fbb_.push_slot::<u8>(InstructionErrorData::VT_INSTRUCTION_NUMBER, instruction_number, 0);
  }
  #[inline]
  pub fn add_err(&mut self, err: flatbuffers::WIPOffset<InstructionError<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<InstructionError>>(InstructionErrorData::VT_ERR, err);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> InstructionErrorDataBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> InnerByte<'a> {
  ...
  pub fn inner_byte(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(InnerByte::VT_INNER_BYTE, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> InnerByteBuilder<'a, 'b> {
  ...
  pub fn add_inner_byte(&mut self, inner_byte: u8) {
    self.fbb_.push_slot::<u8>(InnerByte::VT_INNER_BYTE, inner_byte, 0);
  }
  #[inline]
...
impl<'a> Uint32Value<'a> {
  ...
  pub fn value(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(Uint32Value::VT_VALUE, Some(0)).unwrap()}
  }
}
...
impl<'a> InstructionError<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.err_data { builder.add_err_data(x); }
  ...
  pub fn err_type(&self) -> InstructionErrorType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<InstructionErrorType>(InstructionError::VT_ERR_TYPE, Some(InstructionErrorType::GenericError)).unwrap()}
  }
  #[inline]
  pub fn err_data_type(&self) -> InstructionErrorInnerData {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<InstructionErrorInnerData>(InstructionError::VT_ERR_DATA_TYPE, Some(InstructionErrorInnerData::NONE)).unwrap()}
  }
  #[inline]
  pub fn err_data(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(InstructionError::VT_ERR_DATA, None)}
  }
  #[inline]
  #[allow(non_snake_case)]
...
impl flatbuffers::Verifiable for InstructionError<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<InstructionErrorInnerData, _>("err_data_type", Self::VT_ERR_DATA_TYPE, "err_data", Self::VT_ERR_DATA, false, |key, v, pos| {
        match key {
          InstructionErrorInnerData::BorshIoError => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StringValue>>("InstructionErrorInnerData::BorshIoError", pos),
          InstructionErrorInnerData::Custom => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Uint32Value>>("InstructionErrorInnerData::Custom", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a: 'b, 'b> InstructionErrorBuilder<'a, 'b> {
  ...
  pub fn add_err_type(&mut self, err_type: InstructionErrorType) {
    self.fbb_.push_slot::<InstructionErrorType>(InstructionError::VT_ERR_TYPE, err_type, InstructionErrorType::GenericError);
  }
  #[inline]
  pub fn add_err_data_type(&mut self, err_data_type: InstructionErrorInnerData) {
    self.fbb_.push_slot::<InstructionErrorInnerData>(InstructionError::VT_ERR_DATA_TYPE, err_data_type, InstructionErrorInnerData::NONE);
  }
  #[inline]
  pub fn add_err_data(&mut self, err_data: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(InstructionError::VT_ERR_DATA, err_data);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> InstructionErrorBuilder<'a, 'b> {
    let start = _fbb.start_table();
      ...
      match self.err_data_type() {
        InstructionErrorInnerData::BorshIoError => {
          if let Some(x) = self.err_data_as_borsh_io_error() {
            ...
            ds.field("err_data", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        InstructionErrorInnerData::Custom => {
...
impl<'a> TransactionError<'a> {
  ...
  pub fn err_type(&self) -> TransactionErrorType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<TransactionErrorType>(TransactionError::VT_ERR_TYPE, Some(TransactionErrorType::AccountInUse)).unwrap()}
  }
  #[inline]
  pub fn err_data_type(&self) -> TransactionErrorData {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<TransactionErrorData>(TransactionError::VT_ERR_DATA_TYPE, Some(TransactionErrorData::NONE)).unwrap()}
  }
  #[inline]
  pub fn err_data(&self) -> Option<flatbuffers::Table<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(TransactionError::VT_ERR_DATA, None)}
  }
  #[inline]
  #[allow(non_snake_case)]
...
impl<'a: 'b, 'b> TransactionErrorBuilder<'a, 'b> {
  ...
  pub fn add_err_type(&mut self, err_type: TransactionErrorType) {
    self.fbb_.push_slot::<TransactionErrorType>(TransactionError::VT_ERR_TYPE, err_type, TransactionErrorType::AccountInUse);
  }
  #[inline]
  pub fn add_err_data_type(&mut self, err_data_type: TransactionErrorData) {
    self.fbb_.push_slot::<TransactionErrorData>(TransactionError::VT_ERR_DATA_TYPE, err_data_type, TransactionErrorData::NONE);
  }
  #[inline]
  pub fn add_err_data(&mut self, err_data: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionError::VT_ERR_DATA, err_data);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> TransactionErrorBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> TransactionStatusMeta<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.post_token_balances { builder.add_post_token_balances(x); }
    if let Some(x) = args.pre_token_balances { builder.add_pre_token_balances(x); }
    ...
    if let Some(x) = args.post_balances { builder.add_post_balances(x); }
    if let Some(x) = args.pre_balances { builder.add_pre_balances(x); }
  ...
  pub fn status(&self) -> Option<TransactionError<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<TransactionError>>(TransactionStatusMeta::VT_STATUS, None)}
  }
  #[inline]
  pub fn fee(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(TransactionStatusMeta::VT_FEE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn pre_balances(&self) -> Option<flatbuffers::Vector<'a, u64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u64>>>(TransactionStatusMeta::VT_PRE_BALANCES, None)}
  }
  #[inline]
  pub fn post_balances(&self) -> Option<flatbuffers::Vector<'a, u64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u64>>>(TransactionStatusMeta::VT_POST_BALANCES, None)}
  }
  #[inline]
  pub fn inner_instructions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<InnerInstructions<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<InnerInstructions>>>>(TransactionStatusMeta::VT_INNER_INSTRUCTIONS, None)}
  }
  #[inline]
  pub fn log_messages(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(TransactionStatusMeta::VT_LOG_MESSAGES, None)}
  }
  #[inline]
  pub fn pre_token_balances(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransactionTokenBalance<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransactionTokenBalance>>>>(TransactionStatusMeta::VT_PRE_TOKEN_BALANCES, None)}
  }
  #[inline]
  pub fn post_token_balances(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransactionTokenBalance<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransactionTokenBalance>>>>(TransactionStatusMeta::VT_POST_TOKEN_BALANCES, None)}
  }
  #[inline]
  pub fn rewards(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Reward<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Reward>>>>(TransactionStatusMeta::VT_REWARDS, None)}
  }
}
...
impl flatbuffers::Verifiable for TransactionStatusMeta<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<TransactionError>>("status", Self::VT_STATUS, false)?
     .visit_field::<u64>("fee", Self::VT_FEE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u64>>>("pre_balances", Self::VT_PRE_BALANCES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u64>>>("post_balances", Self::VT_POST_BALANCES, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<TransactionTokenBalance>>>>("pre_token_balances", Self::VT_PRE_TOKEN_BALANCES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<TransactionTokenBalance>>>>("post_token_balances", Self::VT_POST_TOKEN_BALANCES, false)?
...
pub struct TransactionStatusMetaArgs<'a> {
    ...
    pub pre_token_balances: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransactionTokenBalance<'a>>>>>,
    pub post_token_balances: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransactionTokenBalance<'a>>>>>,
...
impl<'a: 'b, 'b> TransactionStatusMetaBuilder<'a, 'b> {
  ...
  pub fn add_status(&mut self, status: flatbuffers::WIPOffset<TransactionError<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<TransactionError>>(TransactionStatusMeta::VT_STATUS, status);
  }
  #[inline]
  pub fn add_fee(&mut self, fee: u64) {
    self.fbb_.push_slot::<u64>(TransactionStatusMeta::VT_FEE, fee, 0);
  }
  #[inline]
  pub fn add_pre_balances(&mut self, pre_balances: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionStatusMeta::VT_PRE_BALANCES, pre_balances);
  }
  #[inline]
  pub fn add_post_balances(&mut self, post_balances: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionStatusMeta::VT_POST_BALANCES, post_balances);
  }
  #[inline]
  pub fn add_inner_instructions(&mut self, inner_instructions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<InnerInstructions<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionStatusMeta::VT_INNER_INSTRUCTIONS, inner_instructions);
  }
  #[inline]
  pub fn add_log_messages(&mut self, log_messages: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionStatusMeta::VT_LOG_MESSAGES, log_messages);
  }
  #[inline]
  pub fn add_pre_token_balances(&mut self, pre_token_balances: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<TransactionTokenBalance<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionStatusMeta::VT_PRE_TOKEN_BALANCES, pre_token_balances);
  }
  #[inline]
  pub fn add_post_token_balances(&mut self, post_token_balances: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<TransactionTokenBalance<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionStatusMeta::VT_POST_TOKEN_BALANCES, post_token_balances);
  }
  #[inline]
  pub fn add_rewards(&mut self, rewards: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Reward<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionStatusMeta::VT_REWARDS, rewards);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> TransactionStatusMetaBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> TransactionTokenBalance<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.program_id { builder.add_program_id(x); }
    if let Some(x) = args.owner { builder.add_owner(x); }
    if let Some(x) = args.ui_token_amount { builder.add_ui_token_amount(x); }
  ...
  pub fn account_index(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(TransactionTokenBalance::VT_ACCOUNT_INDEX, Some(0)).unwrap()}
  }
  #[inline]
  pub fn mint(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TransactionTokenBalance::VT_MINT, None)}
  }
  #[inline]
  pub fn ui_token_amount(&self) -> Option<UiTokenAmount<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<UiTokenAmount>>(TransactionTokenBalance::VT_UI_TOKEN_AMOUNT, None)}
  }
  #[inline]
  pub fn owner(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TransactionTokenBalance::VT_OWNER, None)}
  }
  #[inline]
  pub fn program_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TransactionTokenBalance::VT_PROGRAM_ID, None)}
  }
}
...
impl flatbuffers::Verifiable for TransactionTokenBalance<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<UiTokenAmount>>("ui_token_amount", Self::VT_UI_TOKEN_AMOUNT, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("owner", Self::VT_OWNER, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("program_id", Self::VT_PROGRAM_ID, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> TransactionTokenBalanceBuilder<'a, 'b> {
  ...
  pub fn add_account_index(&mut self, account_index: u8) {
    self.fbb_.push_slot::<u8>(TransactionTokenBalance::VT_ACCOUNT_INDEX, account_index, 0);
  }
  #[inline]
  pub fn add_mint(&mut self, mint: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionTokenBalance::VT_MINT, mint);
  }
  #[inline]
  pub fn add_ui_token_amount(&mut self, ui_token_amount: flatbuffers::WIPOffset<UiTokenAmount<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<UiTokenAmount>>(TransactionTokenBalance::VT_UI_TOKEN_AMOUNT, ui_token_amount);
  }
  #[inline]
  pub fn add_owner(&mut self, owner: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionTokenBalance::VT_OWNER, owner);
  }
  #[inline]
  pub fn add_program_id(&mut self, program_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionTokenBalance::VT_PROGRAM_ID, program_id);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> TransactionTokenBalanceBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> UiTokenAmount<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.ui_amount_string { builder.add_ui_amount_string(x); }
  ...
  pub fn ui_amount(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(UiTokenAmount::VT_UI_AMOUNT, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn decimals(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(UiTokenAmount::VT_DECIMALS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn amount(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(UiTokenAmount::VT_AMOUNT, None)}
  }
  #[inline]
  pub fn ui_amount_string(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(UiTokenAmount::VT_UI_AMOUNT_STRING, None)}
  }
}
...
impl flatbuffers::Verifiable for UiTokenAmount<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("amount", Self::VT_AMOUNT, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("ui_amount_string", Self::VT_UI_AMOUNT_STRING, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> UiTokenAmountBuilder<'a, 'b> {
  ...
  pub fn add_ui_amount(&mut self, ui_amount: f64) {
    self.fbb_.push_slot::<f64>(UiTokenAmount::VT_UI_AMOUNT, ui_amount, 0.0);
  }
  #[inline]
  pub fn add_decimals(&mut self, decimals: u8) {
    self.fbb_.push_slot::<u8>(UiTokenAmount::VT_DECIMALS, decimals, 0);
  }
  #[inline]
  pub fn add_amount(&mut self, amount: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(UiTokenAmount::VT_AMOUNT, amount);
  }
  #[inline]
  pub fn add_ui_amount_string(&mut self, ui_amount_string: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(UiTokenAmount::VT_UI_AMOUNT_STRING, ui_amount_string);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> UiTokenAmountBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> Reward<'a> {
  ...
  pub fn pubkey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Reward::VT_PUBKEY, None)}
  }
  #[inline]
  ...
  pub fn reward_type(&self) -> RewardType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<RewardType>(Reward::VT_REWARD_TYPE, Some(RewardType::None)).unwrap()}
  }
  #[inline]
...
impl<'a: 'b, 'b> RewardBuilder<'a, 'b> {
  ...
  pub fn add_reward_type(&mut self, reward_type: RewardType) {
    self.fbb_.push_slot::<RewardType>(Reward::VT_REWARD_TYPE, reward_type, RewardType::None);
  }
  #[inline]
  pub fn add_commission(&mut self, commission: u8) {
    self.fbb_.push_slot::<u8>(Reward::VT_COMMISSION, commission, 0);
  }
  #[inline]
